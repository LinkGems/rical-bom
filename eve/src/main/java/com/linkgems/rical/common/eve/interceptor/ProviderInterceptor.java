package com.linkgems.rical.common.eve.interceptor;

import cn.hutool.core.util.StrUtil;
import com.linkgems.rical.common.eve.utils.ThreadLocalUtil;
...
public class ProviderInterceptor {
     ...
     * 其中后面跟着“?”的是可选项
     */
    @Pointcut("execution(public * com.linkgems..*.provider.*.*(..)) || execution(public * com.linkgems..*.controller.*.*(..))")
